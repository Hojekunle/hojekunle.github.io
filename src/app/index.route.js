(function ()
{
    ...
    /** @ngInject */
    function routeConfig($stateProvider, $urlRouterProvider, $locationProvider, growlProvider)
    {
        ...
        // State definitions
        // render main layout in index (parent view:index.html), render toolbar et al (child views) 
        // in url specified by main layout in app state i.e layouts[layoutStyle].main e.g vertical-navigation.html
