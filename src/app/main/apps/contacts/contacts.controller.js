(function ()
{
    ...
    /** @ngInject */
    function ContactsController($scope, $mdSidenav, Contacts, User, msUtils, $mdDialog, $document, msApi, dataFactory, growl)
    {
        ...
        function deleteContact(contact)
        {
            ...
            //msApi.request('products.products@delete', contact.id, '', '');
            console.log("deleting...");
            dataFactory.httpRequest(vm.apiUrl+'products/'+contact.id,'DELETE').then(function(data) {
